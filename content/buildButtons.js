//TODO #49 - confirm depreciation and delete module?

//buttons.js
//is this whole thing depreciated?
...
//                 console.log(`${linkText} is internal`)
//             } else {
//                 externalOrs.push(aLink)
//                 console.log(`${linkText} is external`)
//             }
//         })
...
//         const testRegExp = new RegExpHandler('\\b${thisChapNum}\\.').RE
//         return testRegExp.test(linkText)
//     }
